...
def chat():
    ...
    if 'department' in user_input:
        responses.append(
            ...
            '<h1 style="color: #FF5733; font-size: 36px; margin: 20px 0;">Welcome to XYZ Engineering College</h1>'
            '<p style="color: #333; font-size: 18px; margin-bottom: 20px;">XYZ Engineering College is dedicated to providing exceptional education and promoting innovation. We offer a diverse range of academic programs that prepare students for successful careers in various fields of engineering. Explore our programs:</p>'
            '<ul style="list-style-type: disc; padding-left: 20px;">'
            '<li style="color: #007BFF; font-size: 20px; margin: 10px 0;">Bachelor of Technology (B.Tech) - A comprehensive undergraduate program for future engineers.</li>'
            '<li style="color: #28a745; font-size: 20px; margin: 10px 0;">Master of Technology (M.Tech) - Advance your engineering skills and knowledge.</li>'
            '<li style="color: #FF5733; font-size: 20px; margin: 10px 0;">Bachelor of Computer Science and Engineering (B.CSE) - Stay at the forefront of technology and innovation.</li>'
            '<li style="color: #28a745; font-size: 20px; margin: 10px 0;">Master of Computer Science and Engineering (M.CSE) - Take your technical expertise to the next level.</li>'
            '<li style="color: #007BFF; font-size: 20px; margin: 10px 0;">Bachelor of Electronics and Communication Engineering (B.ECE) - Explore the world of electronics and communication.</li>'
            '<li style="color: #28a745; font-size: 20px; margin: 10px 0;">Master of Electronics and Communication Engineering (M.ECE) - Master the art of electronics and communication engineering.</li>'
            '<li style="color: #007BFF; font-size: 20px; margin: 10px 0;">Bachelor of Mechanical Engineering (B.ME) - Dive into the world of mechanical engineering.</li>'
            '<li style="color: #28a745; font-size: 20px; margin: 10px 0;">Master of Mechanical Engineering (M.ME) - Take your mechanical engineering skills to the next level.</li>'
            '<li style="color: #FF5733; font-size: 20px; margin: 10px 0;">Bachelor of Civil Engineering (B.CE) - Prepare for a successful career in civil engineering and infrastructure.</li>'
            '<li style="color: #28a745; font-size: 20px; margin: 10px 0;">Master of Civil Engineering (M.CE) - Advance your civil engineering skills with our M.CE program.</li>'
            '</ul>'
            '<p style="color: #333; font-size: 18px; margin: 20px 0;">Our academic programs are designed to provide a high standard of education and ensure that students are well-prepared for their future careers in the field of engineering. The faculty at XYZ Engineering College is highly qualified and dedicated to providing quality education. They bring expertise and real-world experience to the classroom, enriching the learning experience.</p>'
            '<p style="color: #333; font-size: 18px; margin: 20px 0;">In addition to academic excellence, we also offer a range of extracurricular activities, student organizations, and opportunities for personal and professional development. We believe in nurturing well-rounded individuals who are ready to make a positive impact on the engineering world.</p>'
            '<p style="color: #333; font-size: 18px; margin: 20px 0;">Whether youre a prospective student or a member of our college community, were excited to have you with us on this journey of learning and growth. Explore our website for more information and feel free to reach out to us with any questions you may have.</p>'
            '</div>'
    ...
    if 'fee' in user_input:
        responses.append(
            ...
            '<ul style="list-style-type: disc; padding-left: 20px;">'
            '<li style="font-weight: bold;">B.Tech in Computer Science:</li>'
            '<ul style="list-style-type: circle; padding-left: 20px;">'
            '<li>In-state students: Rs. 50,000 per year</li>'
            '<li>Out-of-state students: Rs. 1,00,000 per year</li>'
            '</ul>'
            '<li style="font-weight: bold;">B.Tech in Engineering (Please check the program for specific details):</li>'
            '<ul style="list-style-type: circle; padding-left: 20px;">'
            '<li>The Engineering program\'s fee structure can differ depending on the specific branch of engineering you choose, such as Mechanical, Electrical, or Civil Engineering.</li>'
    ...
    if 'scholarship' in user_input:
        responses.append(
            '<div style="width: 75%; margin: 0 auto; text-align: center; font-family: Agrandir, sans-serif; padding: 20px; border-radius: 10px;">'
    '<h1 style="color: #FF5733; font-size: 36px; margin: 20px 0;">Scholarships at Indian Engineering Colleges</h1>'
    '<ul style="list-style-type: disc; text-align: left; padding-left: 20px;">'
        '<li>Academic Excellence Scholarship: Awarded to students with exceptional academic records in engineering programs.</li>'
        '<li>Need-Based Financial Aid: Designed to assist engineering students with demonstrated financial need.</li>'
        '<li>STEM Scholarships: Available for students pursuing engineering degrees in science, technology, engineering, and mathematics.</li>'
    '</ul>'
    '<p style="color: #333; font-size: 18px; margin: 20px 0; text-align: left;">To explore available scholarships and get a complete list, visit the college\'s official scholarship page or contact the financial aid office of the Indian Engineering College.</p>'
    '<p style="color: #333; font-size: 18px; margin: 20px 0; text-align: left;">To apply for scholarships at this college:</p>'
    '<ol style="list-style-type: decimal; text-align: left; padding-left: 20px;">'
        '<li>Visit the college\'s scholarship page on their official website to explore available scholarship opportunities for engineering students.</li>'
        ...
        '<li>Some scholarships may require additional materials, such as essays, letters of recommendation, or a portfolio. Make sure to provide the necessary information as requested for engineering-specific scholarships.</li>'
    '</ol>'
    '<p style="color: #333; font-size: 18px; margin: 20px 0; text-align: left;">International students can also benefit from scholarships at Indian engineering colleges, including:</p>'
    '<ul style="list-style-type: disc; text-align: left; padding-left: 20px;">'
        '<li>International Merit Scholarship: Awarded to outstanding international engineering students based on academic achievements and extracurricular involvement.</li>'
        '<li>Global Diversity Scholarship: Aimed at promoting diversity on campus by supporting international engineering students from various backgrounds.</li>'
    '</ul>'
    '<p style="color: #333; font-size: 18px; margin: 20px 0; text-align: left;">For more information on scholarships for international engineering students, visit the college\'s official scholarship page or reach out to the international student services office.</p>'
    '<p style="color: #333; font-size: 18px; margin: 20px 0; text-align: left;">Scholarship application deadlines can vary, so it\'s important to check the deadline for each scholarship opportunity you\'re interested in. These deadlines may not align with the college\'s admission application deadlines, so be sure to check the scholarship details on the college\'s website.</p>'
    '<p style="color: #333; font-size: 18px; margin: 20px 0; text-align: left;">Students often have the flexibility to combine multiple scholarships at Indian engineering colleges to support their engineering education. However, there may be limitations or restrictions depending on the scholarship policies. Be sure to review the terms and conditions of each scholarship to determine if they can be combined. If you have questions about combining scholarships, seek guidance from the financial aid office for more information.</p>'
'</div>'
    ...
    if 'admission' in user_input:
        responses.append(
            ...
            '<h1 style="color: #FF5733; font-size: 36px; margin: 20px 0;">Admission Details for Indian Engineering Colleges:</h1>'

            '<ul style="list-style-type: disc; padding-left: 20px;">'
            '<li>Application Requirements: Applicants are typically required to submit the following materials when applying for admission to Indian engineering colleges:</li>'
            '<ul style="list-style-type: circle; padding-left: 20px;">'
            ...
            '<li>Standardized Test Scores: Some Indian engineering colleges may require entrance exam scores like JEE Main or other relevant test scores. Be sure to check the specific requirements for your intended program.</li>'
            ...
            '</ul>'
            '<li>Application Deadlines: Indian engineering colleges typically have application deadlines for different admission rounds. Be sure to submit your application before the specified deadline to be considered for admission.</li>'
            ...
            '<li>Financial Aid and Scholarships: Indian engineering colleges offer a range of financial aid options, including scholarships, grants, and loans. Visit the college s financial aid page for details on how to apply and the types of financial aid available.< / li > '
        '</ul>'
        ...
        '<li>Additional Information: For more comprehensive admission details, including program-specific requirements and contact information for the admissions office, please visit the official Indian engineering college website or get in touch with the admissions office directly.</li>'
        '</div>'
